...
<div class="container">
    ...
    <form name="cadastro-usuarios" method="post" action="usuarios-cadastrar.php" class="row mt-3" enctype="multipart/form-data">
        ...
        <p class="col-6">
            <label class="form-label" for="validationDefault10">Anexo do RG:</label>
            <input type="file" name="arquivo_rg" class="form-control" id="validationDefault10" required>
        </p> 
        <p class="col-6">
            <label class="form-label" for="validationDefault10">Anexo do CPF:</label>
            <input type="file" name="arquivo_cpf" class="form-control" id="validationDefault10" required>
        </p> 
